            ...
            {clicked && (
                ...
                <form>
                    ...
                    <div>
                        ...
                        <br></br>
                        <input type="text" name="price" placeholder="Enter price of game" id="price" value={formData.price} />
                    </div>
                    <div>
                        <label for="genres">Genres</label>
                        <br></br>
                        <input type="text" name="genres" placeholder="Enter first genre category" id="genre1" value={formData.genres[0]} />
                        <br></br>
                        <input type="text" name="genres" placeholder="Enter second genre category" id="genre2" value={formData.genres[1]} />
                        <br></br>
                        <input type="text" name="genres" placeholder="Enter third genre category" id="genre3" value={formData.genres[2]} />
                    </div>
